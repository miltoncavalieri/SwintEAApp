...
@Entity
@Table(name = "vw_clicaso_cancelar_solicitacao_light")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "VwClicasoCancelarSolicitacaoLight.findAll", query = "SELECT v FROM VwClicasoCancelarSolicitacaoLight v"),
    @NamedQuery(name = "VwClicasoCancelarSolicitacaoLight.findByPbuId", query = "SELECT v FROM VwClicasoCancelarSolicitacaoLight v WHERE v.pbuId = :pbuId")        
})
public class VwClicasoCancelarSolicitacaoLight implements Serializable {
    ...
    public VwClicasoCancelarSolicitacaoLight() {
    }
