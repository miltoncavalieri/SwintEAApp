...
@Entity
@Table(name = "vw_clicaso_pendenvio")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "VwClicasoPendenvio.findAll", query = "SELECT v FROM VwClicasoPendenvio v")})
public class VwClicasoPendenvio implements Serializable {
