...
@Entity
@Table(name = "vw_clicaso_aguardar")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "VwClicasoAguardar.findAll", query = "SELECT v FROM VwClicasoAguardar v")})
public class VwClicasoAguardar implements Serializable {
