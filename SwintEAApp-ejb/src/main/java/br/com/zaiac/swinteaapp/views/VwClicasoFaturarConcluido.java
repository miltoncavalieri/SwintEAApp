...
@Entity
@Table(name = "vw_clicaso_faturar_concluido")
@XmlRootElement
@NamedQueries
({
    @NamedQuery(name = "VwClicasoFaturarConcluido.findAll", query = "SELECT v FROM VwClicasoFaturarConcluido v"),
    @NamedQuery(name = "VwClicasoFaturarConcluido.findByA04IdCasoCliId", query = "SELECT v FROM VwClicasoFaturarConcluido v WHERE v.a04IdCasoCriar = :a04IdCaso AND v.cliId = :cliId")
})
public class VwClicasoFaturarConcluido implements Serializable {
    ...
    public VwClicasoFaturarConcluido() {
    }
